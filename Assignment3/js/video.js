...
window.onload = function(){
    var videoContainer = document.querySelector("#videoId");
    var visual = "";
    visual += "<video width=\"" + video.width + "\" height=\"" + video.height + "\" controls>";
    for(var i = 0; i < video.source.length; i++){
        visual += "<source src=\"" + video.source[i].src + "\" type=\"" + video.source[i].type + "\">";
    }
    visual += "</video>";
    videoContainer.innerHTML += visual;
}